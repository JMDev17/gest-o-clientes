...
export default function PaymentList({
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 overflow-hidden">
      {/* Header — desktop only */}
      <div className="hidden sm:grid grid-cols-[1fr_1fr_116px_106px_96px_68px] gap-4 px-5 py-3 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-800 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">
...
function PaymentRow({ payment, onEdit, onDelete }) {
  ...
  return (
    <div className="px-5 py-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/40 transition-colors">
      {/* Desktop */}
      <div className="hidden sm:grid grid-cols-[1fr_1fr_116px_106px_96px_68px] items-center gap-4">
