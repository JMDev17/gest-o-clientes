...
import {
  ...
  CalendarDays, RefreshCw, LogOut, Newspaper, FileText,
  Scissors, BarChart3, X, Building2, Wallet, ArrowLeftRight,
...
const ICONS = {
  LayoutDashboard, Users, CreditCard, CheckSquare, CalendarDays,
  RefreshCw, Newspaper, FileText, Scissors, BarChart3,
  Building2, Wallet, ArrowLeftRight, FileBarChart2, Settings,
}
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        {workspace.nav.map((item, idx) => {
          // Separador de grupo
          if (item.group) {
            return (
              <div key={`group-${idx}`} className="pt-4 pb-1 first:pt-0">
