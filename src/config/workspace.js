...
export const configs = {
  marketing: {
    ...
    nav: [
      ...
      // ── Módulo Financeiro ──────────────────────────────────────
      { group: 'Financeiro' },
      { to: '/financeiro',             label: 'Visão Geral',    icon: 'BarChart3'      },
      { to: '/financeiro/empresa',     label: 'Empresa',        icon: 'Building2'      },
      { to: '/financeiro/pessoal',     label: 'Pró-labore',     icon: 'Wallet'         },
      { to: '/financeiro/fluxo',       label: 'Fluxo de Caixa', icon: 'ArrowLeftRight' },
      { to: '/financeiro/relatorios',  label: 'Relatórios',     icon: 'FileBarChart2'  },
      // ── Operacional ────────────────────────────────────────────
      { group: 'Operacional' },
  ...
  estetica: {
    ...
    nav: [
      ...
      { group: 'Financeiro' },
      { to: '/financeiro',             label: 'Visão Geral',    icon: 'BarChart3'      },
      { to: '/financeiro/empresa',     label: 'Clínica',        icon: 'Building2'      },
      { to: '/financeiro/pessoal',     label: 'Pró-labore',     icon: 'Wallet'         },
      { to: '/financeiro/fluxo',       label: 'Fluxo de Caixa', icon: 'ArrowLeftRight' },
      { to: '/financeiro/relatorios',  label: 'Relatórios',     icon: 'FileBarChart2'  },
      // ── Operacional ────────────────────────────────────────────
